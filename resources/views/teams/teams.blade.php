@extends('layouts.app') @section('title', $viewData['title']) @section('subtitle', $viewData['subtitle'])
@section('color', $viewData['color']) @section('teamdesc', $viewData['teamdesc']) @section('carimage',
$viewData['carimage'])
@section('driver1name', $viewData['driver1name']) @section('driver1img', $viewData['driver1img'])
@section('driver1desc', $viewData['driver1desc'])
@section('driver2name', $viewData['driver2name']) @section('driver2img', $viewData['driver2img'])
@section('driver2desc', $viewData['driver2desc'])
@section('carousel1', $viewData['carousel1']) @section('carousel2', $viewData['carousel2']) @section('carousel3',
$viewData['carousel3'])
@section('carousel4', $viewData['carousel4']) @section('content')
...
<div class="container-fluid">
    ...
    <div class="container">
        <h2 class="formula1" style="color: @yield('color')">Check what's popular with @yield('subtitle') fans</h2>
        <br>
        <div class="row gy-4">
        ...
        <td><button class="btn btn-outline-secondary" style="color:@yield('color')" onclick="location.href='{{ route('product.index') }}'">View More</button></td>
        </div>
    </div>
    </br>
    <div class="row">
