...
@section('color', $viewData['color']) @section('teamdesc', $viewData['teamdesc']) @section('carimage', $viewData['carimage'])
@section('driver1name', $viewData['driver1name']) @section('driver1img', $viewData['driver1img']) @section('driver1desc', $viewData['driver1desc'])
@section('driver2name', $viewData['driver2name']) @section('driver2img', $viewData['driver2img']) @section('driver2desc', $viewData['driver2desc'])
@section('carousel1', $viewData['carousel1']) @section('carousel2', $viewData['carousel2']) @section('carousel3', $viewData['carousel3'])
